        ...
        <div className="container-max">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              Aria Event התחילה כרעיון פשוט: להפוך כל אירוע לזיכרון בלתי נשכח. על פני 15 שנים, אנחנו בנינו מוניטין של אמינות, יצירתיות ודחיקות כוללת.
            </p>
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              היום, אנחנו גם 20 עובדים חדשים שמוקדשים ויצירתיים שמתחייבים לעשות את כל אירוע מיוחד.
            </p>
            <p className="text-lg text-gray-700 leading-relaxed">
              מחתונות טבעות וחגיגות בר/בת מצווה, ועד אירועים עסקיים בעלי קנה מידה גדול, אנחנו עשינו הכל ודאים שכל אחד הולך עם חיוך.
            </p>
          </div>
        </div>
      </section>
